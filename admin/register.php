  ...
  <fieldset>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <div class="radio">
          <label>
            <input type="radio" name="depart" id="depart" value="X" checked="">
            X
          </label>
        </div>
        <div class="radio">
          <label>
            <input type="radio" name="depart" id="depart" value="XII">
          XII
          </label>
        </div>
      </div>
    ...
    <div class="form-group">
      ...
      <div class="col-lg-10">
        <div class="radio">
          <label>
            <input type="radio" name="role" id="role" value="teacher" checked="">
           Teacher
          </label>
        </div>
        <div class="radio">
